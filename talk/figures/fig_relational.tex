...
\draw[rel] (b1) -- (b2);
\node[note] at ( 70.5,7) {present in the later source,\\past-dated, yet unavailable\\at the decision time};
...
\draw[rel] (c1) -- (c2);
\node[note] at (119.5,7) {dependence at the coarser level\\$\Rightarrow$ the \emph{declared} unit is too fine};
\end{tikzpicture}
