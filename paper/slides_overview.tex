...
\begin{frame}{Main Real Result}
  \vspace{-0.25cm}
  \begin{center}
    \includegraphics[width=0.99\linewidth,height=0.72\textheight,keepaspectratio]{figures/fig_bk_residual_talk.pdf}
  \end{center}
  \vspace{-0.40cm}
  {\footnotesize\bfseries Learned correction is worse at every tested staleness. At 168 h: SGP4 26.9 Hz versus 45.3 Hz learned; gate closed, deploy SGP4 / never-learn.}
\end{frame}
