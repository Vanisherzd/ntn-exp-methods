...
| sweep runtime | **2.556 s / 47.3 ms per condition** on the generating machine; repository regression guards 3.0 s and 60.0 ms, environment-dependent, not portable bounds | `runtime_seconds` |
