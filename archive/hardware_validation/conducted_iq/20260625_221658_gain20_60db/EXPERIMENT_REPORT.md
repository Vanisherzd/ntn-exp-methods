...
- Run directory: `/Users/laizhendong/Desktop/LEO-Hybrid-PGRL/hardware_conducted_iq/20260625_221658_gain20_60db`
- Attenuation: `60 dB`
- USRP channel: `0`
- UHD antenna: `RX2`
- RX gain: `20.0 dB`
...
- TX-OFF: `noise_rx2a_gain20_60db.npy`
- TX-ON: `txon_rx2a_gain20_60db.npy`
- Metadata: `capture_metadata.json`

## TX-ON/TX-OFF spectrum evidence

- noise floor: `-75.033 dB`
- TX-ON peak: `-59.371 dB`
- TX-ON minus TX-OFF: `0.751 dB`
- max_abs_iq: `0.000838`
...
- recommended next step: `TX-ON is still weak after RX gain 20 dB. Manual next step: consider testing 50 dB attenuation later by removing the 10 dB pad. Do not change attenuation automatically.`
