...
- Run directory: `/Users/laizhendong/Desktop/LEO-Hybrid-PGRL/hardware_conducted_iq/20260625_223023_gain10_50db`
- Attenuation: `50 dB`
- USRP channel: `0`
- UHD antenna: `RX2`
- RX gain: `10.0 dB`
...
- TX-OFF: `noise_rx2a_gain10_50db.npy`
- TX-ON: `txon_rx2a_gain10_50db.npy`
- Metadata: `capture_metadata.json`

## TX-ON/TX-OFF spectrum evidence

- noise floor: `-76.570 dB`
- TX-ON peak: `-61.249 dB`
- TX-ON minus TX-OFF: `0.480 dB`
...
- recommended next step: `TX-ON is too weak at RX gain 10 dB. Continue to the next configured RX gain while keeping 50 dB attenuation.`
