...
- Run directory: `/Users/laizhendong/Desktop/LEO-Hybrid-PGRL/hardware_conducted_iq/20260625_221658_gain10_60db`
- Attenuation: `60 dB`
- USRP channel: `0`
- UHD antenna: `RX2`
- RX gain: `10.0 dB`
...
- TX-OFF: `noise_rx2a_gain10_60db.npy`
- TX-ON: `txon_rx2a_gain10_60db.npy`
- Metadata: `capture_metadata.json`

## TX-ON/TX-OFF spectrum evidence

- noise floor: `-76.626 dB`
- TX-ON peak: `-61.129 dB`
- TX-ON minus TX-OFF: `0.671 dB`
- max_abs_iq: `0.000655`
...
- recommended next step: `TX-ON is too weak at RX gain 10 dB. Continue to the next configured RX gain while keeping 60 dB attenuation.`
